    ...
    return (
        <div className=' bg-[#D9D9D9] pt-6 pb-3   '>
                <div className='md:hidden '>
                   ...
                   <div className={`w-2/3 md:w-10/12 ml-8 md:mx-auto md:flex items-center justify-between rounded  bg-white md:bg-[#D9D9D9] absolute md:static  p-3  ${openIcon === true ? 'top-14' : '-top-56'} `} >
